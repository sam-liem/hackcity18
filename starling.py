...
class account:
    ...
    # SAVING GOALS 
    def returnSavingGoals(self):
        savingGoals = self.getSavingGoals()
        if savingGoals == {}:
            return {}
    ...
    def addSavingGoal(self, data):
        ...
        speech = "You added a new savings goal: "+data['name'] + " of " + str(data['target']['minorUnits'])
